    ...
    <div class="info-popup">
      <div class="info-content">
        ...
        <div class="info-section">
          <h3>Welcome to FGE Doko</h3>
          <p>A tribute to Foreground Eclipse, a post-hardcore band born in 2009. Our mission is to share their music for free without any ads.</p>
        </div>
        ...
        <div class="info-section">
          ...
          <p>If you love Foreground Eclipse, feel free to add me on Discord or Twitter - I'd be more than happy to chat with you!</p>
...
<style>
  ...
  .info-section h3 {
    ...
    border-bottom: 1px solid rgba(242,233,226, 0.2);
